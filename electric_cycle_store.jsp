...
<%
   ...
   try
   {
      ...
      try
	  {
         ...
         query = "SELECT * FROM electric_cycle_store";
         sql_query = query;
         ...
         {
            previous_page_link = "electric_cycle_store.jsp?page=" + (current_page - 1);
         }
		 
         if(total_page > current_page)
         {
            next_page_link = "electric_cycle_store.jsp?page=" + (current_page + 1);
         }		 
...
%>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><a href="electric_cycle_store.jsp"><img src="images/buttom_5a.gif" width="281" height="69" border="0"></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <td height="450" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="45" valign="top"> 　　<img src="images/other/banner_electrical.gif" width="834" height="21"><br></td>
      </tr>
<%     
      if(result_count > 0)
	  { 
...
<%
            ...
            {    
               searched_criteria = "electric_cycle_store.jsp?page=" + iPage;

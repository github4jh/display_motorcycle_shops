...
<%  
   ...
   if(userLogout == null || "".equals(userLogout)) 
   { 
...
<table width="890" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="450" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="890" height="55" valign="top"> 　　<img src="images/sell/banner_out.gif" width="839" height="21"></td>
      </tr>
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="70" height="0" valign="bottom">&nbsp;</td>
            <td align="center" valign="bottom"><img src="images/sell/word_out.gif" width="128" height="23"><br>
                <br>
                <a href="index.jsp"><img src="images/sell/button_backindex.jpg" width="130" height="35" border="0"></a><br></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
